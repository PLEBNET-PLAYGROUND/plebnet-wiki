...
Call like this:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki

   Optionally pass the page id of the page you want to download, eg. for debugging:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki --page=180

   Optionally pass the page id of the category, all pages with that category will be exported:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki --category=22

   Optionally pass the namespace id, only pages in that namespace will be exported:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki --namespace=0

   Optionally pass the username and password:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki --username=myuser --password=topsecret

   Optionally pass the directory to dump the export to:
   ./exportMediaWiki2Html.py --url=https://plebnet.wiki --outputDir=export
"""
